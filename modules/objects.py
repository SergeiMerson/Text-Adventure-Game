...
def create_item(name: str, description: str):
    ...
    Return:
        {item} dictionary
    """
    item = {'category': 'item', 'name': name, 'description': description, 'location': {}, 'actions': set()}
...
def add_action(target: dict, keyword: str, commands: tuple):
    ...
    if 'actions' not in target:
        print(f'{target["name"]} is not an appropriate object. Only Player or Items can have actions')
